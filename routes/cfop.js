...
router.post(CFOP_API + 'f2ls/reorder', handlers.Reorder.F2Ls);
...
router.post(CFOP_API + 'olls/reorder', handlers.Reorder.OLLs);
...
router.post(CFOP_API + 'plls/reorder', handlers.Reorder.PLLs);
